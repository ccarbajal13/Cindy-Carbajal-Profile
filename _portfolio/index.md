...
- It is meant to be easier to learn than what typical coding is thought to be.
- Markdown allows for content to be created in a way that is easy to understand for projects like blogs, collaborative projects, notes, etc. 
- It is a universal tool that anyone can engage with and learn. 
  - With markdown I can format certain text to be **bold**.
  - I can also format it to be *italic*. 
  - Or, some **_kind of combination_** of the two can be utilized.
...
- Git is a **powerful version control system** that allows for varying levels of tracking to take place for one’s project.
- It is extremely useful as it allows for modifications to be followed in a detailed manner that describes what was done, when, and by who. 
- Git also allows for branching and merging to take place in a single project. This aids in maintaining a main branch with approved changes, while also having spaces for potential alterations that can be merged later on.
- Through this system, individuals have greater access to collaboration in a way that fosters community and connections. 
- With Git, a project can also be readily distributed in a way that maintains its contents and still allows for others to make alterations.

##  Have you used them before?

Personally, I have never used Markdown or Git prior to starting this seminar. I had never even heard of either one, so I was a bit nervous to start using them. Through Markdown and Git, it is like an entire new world has been unveiled to me. I would not consider myself the most tech savvy, or say that I have considered this kind of content to be one of my interests. However, as I further engage with Markdown, [Git](https://git-scm.com/), and Github, I can see why they draw so many individuals and collaborators in. I have three main goals that I hope to accomplish as I continue to use these technologies. 

1. Reach a level of understanding that allows me to feel comfortable using these kinds of materials.
2. Become more fluent in the use of [Markdown](https://www.markdownguide.org/)  so that I can easily use it without having to extensively think about what command to use.
3. Improve my skills when it comes to navigating around [GitHub](https://github.com/)  and all the tools it has to offer.
